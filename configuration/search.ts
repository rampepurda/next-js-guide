...
export const searchData = [
  ...
  {
    tKey: 'classNames Library',
    link: `${ROUTE.GUIDE_CHAPTERS}/ch-classNamesLib`,
  },
  {
    tKey: 'Dynamic(set/getItem) & Lazy loading & .match email validation',
    link: `${ROUTE.GUIDE_CHAPTERS}/ch-loadingTypes`,
  },
  {
    tKey: 'i18n and next-transform internationalization && interpolation',
  ...
  {
    tKey: 'Redux Toolkit - createSelector',
  ...
  {
    tKey: 'useClient useServer',
    link: `${ROUTE.GUIDE_CHAPTERS}/ch-useClientVsServer`,
  },
  {
    tKey: 'dangerously SetInnerHTML',
