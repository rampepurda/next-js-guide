...
import { navigationGuideLinks, mCh15, breakPoints } from '../../../../configuration'
      ...
      <div className="cols">
        ...
        <div className="col-9">
          ...
          <h4>
            ...
            <br />
            There may come a time when you find it important to trap focus within a DOM node — so
            that when a user hits Tab or Shift+Tab or clicks around, she can't escape a certain
            cycle of focusable elements.
            <br />
