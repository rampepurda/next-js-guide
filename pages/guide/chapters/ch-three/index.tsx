        ...
        <div className="col-9">
          ...
          <InfoBox className={'isInfo'}>
            <h4>
              ...
              <span className="color-is-black">process</span>.env.DB_PASS into the Node.js
              environment automatically allowing you to use them in Next.js data fetching methods
              and API routes.
            </h4>
          </InfoBox>
