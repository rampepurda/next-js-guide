...
export default function ChFontOptimization() {
  return (
    <>
      <Head>
      ...
      <div>
        <h2>Font Optimization Module - how to work in Next and how to setup</h2>
        ...
        <div className="hasOutline">
          ...
          <p>For features and usage, please see the Optimizing Fonts page.</p>
        </div>
